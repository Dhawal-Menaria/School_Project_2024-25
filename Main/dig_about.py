...
content_img = customtkinter.CTkImage(light_image=Image.open("./images/about_content.png"), dark_image=Image.open("./images/about_content.png"), size=(460, 258))
